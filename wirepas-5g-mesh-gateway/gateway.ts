...
import type { mqtt as awsMqtt } from 'aws-iot-device-sdk-v2'
import chalk from 'chalk'
import { merge } from 'lodash-es'
import mqtt from 'mqtt'
import pThrottle from 'p-throttle'
import { cloudToGateway } from './cloudToGateway.ts'
import { decodePayload } from './decodePayload.ts'
import { GenericMessage } from './protobuf/ts/generic_message.ts'
import {
	LED_COLOR,
	LED_STATE,
	getLedState,
...
const { region, accessKeyId, secretAccessKey, gatewayEndpoint } = fromEnv({
	region: 'WIREPAS_GATEWAY_REGION',
	gatewayEndpoint: 'WIREPAS_GATEWAY_MQTT_ENDPOINT',
	accessKeyId: 'WIREPAS_GATEWAY_AWS_ACCESS_KEY_ID',
	secretAccessKey: 'WIREPAS_GATEWAY_AWS_SECRET_ACCESS_KEY',
})(process.env)
